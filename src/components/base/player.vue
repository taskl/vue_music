<template>
    <div>
        ...
        <div class="player" v-if="showplayer">
            ...
            <div class="range">
                <div class="bar">
                    ...
                    <van-slider v-model="value" bar-height="4px" @input="lyricInput" @change="sliderchange" active-color="#ee0a24">
                        <template #button>
            ...
            <div class="buttons">
                <div v-if="playerType == 1" class="iconfont icon-xunhuan1" @click="changeMode"></div>
                <div v-else class="iconfont icon-random" @click="changeMode"></div>
                <div @click="startup" class="iconfont icon-SanMiAppoutlinei1"></div>
                <div :class="['iconfont',iconplay?'icon-zanting1':'icon-ico_zanting_xuanzhong','center']" @click.stop="toggleplay"></div>
                <div @click="lowerFun" class="iconfont icon-SanMiAppoutlinei"></div>
        ...
        <div class="mini-player">
            <div :class="['img','play',{'pause':iconplay}]" @click="showplayer=true">
                <img :src="SongDetail.al.picUrl" alt="">
            </div>
            <div class="text">
                <h2>{{SongDetail.name}}</h2>
        ...
        <div class="musicPlayList" v-if="isMusicPlayList">
            ...
            <div class="dt">
                <h1><i class="iconfont icon-xunhuan1"></i>顺序播放({{playerLists.length}})</h1>
        ...
        <audio ref="audio" controls  :src="musicData" @ended="endedFun" @loadeddata="canplayFun"></audio>
    </div>
</template>
